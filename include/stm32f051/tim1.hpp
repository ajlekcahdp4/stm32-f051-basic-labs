...
namespace stmcpp::stm32f051::mtim1
{

// 
using cr1_register = stmcpp::register_wrapper<0x40012c00, 4, stmcpp::read_write_flag>;
...
// 
using cr2_register = stmcpp::register_wrapper<0x40012c04, 4, stmcpp::read_write_flag>;

namespace cr2_fields
{

// 
constexpr auto ois4 = stmcpp::register_field<cr2_register, 14, 1>{1};

// 
constexpr auto ois3n = stmcpp::register_field<cr2_register, 13, 1>{1};

// 
constexpr auto ois3 = stmcpp::register_field<cr2_register, 12, 1>{1};

// 
constexpr auto ois2n = stmcpp::register_field<cr2_register, 11, 1>{1};
...
// 
using smcr_register = stmcpp::register_wrapper<0x40012c08, 4, stmcpp::read_write_flag>;
...
// 
using dier_register = stmcpp::register_wrapper<0x40012c0c, 4, stmcpp::read_write_flag>;
...
// 
using sr_register = stmcpp::register_wrapper<0x40012c10, 4, stmcpp::read_write_flag>;
...
// 
using egr_register = stmcpp::register_wrapper<0x40012c14, 4, stmcpp::write_only_flag>;
...
// 
using ccmr1_output_register = stmcpp::register_wrapper<0x40012c18, 4, stmcpp::read_write_flag>;
...
// 
using ccmr1_input_register = stmcpp::register_wrapper<0x40012c18, 4, stmcpp::read_write_flag>;
...
// 
using ccmr2_output_register = stmcpp::register_wrapper<0x40012c1c, 4, stmcpp::read_write_flag>;
...
// 
using ccmr2_input_register = stmcpp::register_wrapper<0x40012c1c, 4, stmcpp::read_write_flag>;
...
// 
using ccer_register = stmcpp::register_wrapper<0x40012c20, 4, stmcpp::read_write_flag>;
...
// 
constexpr auto cc3ne = stmcpp::register_field<ccer_register, 10, 1>{1};
...
// 
constexpr auto cc2ne = stmcpp::register_field<ccer_register, 6, 1>{1};
...
// 
using cnt_register = stmcpp::register_wrapper<0x40012c24, 4, stmcpp::read_write_flag>;
...
// 
using psc_register = stmcpp::register_wrapper<0x40012c28, 4, stmcpp::read_write_flag>;
...
// 
using arr_register = stmcpp::register_wrapper<0x40012c2c, 4, stmcpp::read_write_flag>;
...
// 
using rcr_register = stmcpp::register_wrapper<0x40012c30, 4, stmcpp::read_write_flag>;
...
// 
using bdtr_register = stmcpp::register_wrapper<0x40012c44, 4, stmcpp::read_write_flag>;

namespace bdtr_fields
{

// 
constexpr auto moe_disabledidle = stmcpp::register_field<bdtr_register, 15, 1>{0};

// 
constexpr auto moe_enabled = stmcpp::register_field<bdtr_register, 15, 1>{1};

using moe = stmcpp::register_field<bdtr_register, 15, 1>;
...
// 
constexpr auto ossr_disabled = stmcpp::register_field<bdtr_register, 11, 1>{0};

// 
constexpr auto ossr_idlelevel = stmcpp::register_field<bdtr_register, 11, 1>{1};

using ossr = stmcpp::register_field<bdtr_register, 11, 1>;


// 
constexpr auto ossi_disabled = stmcpp::register_field<bdtr_register, 10, 1>{0};

// 
constexpr auto ossi_idlelevel = stmcpp::register_field<bdtr_register, 10, 1>{1};

using ossi = stmcpp::register_field<bdtr_register, 10, 1>;
...
// 
using dcr_register = stmcpp::register_wrapper<0x40012c48, 4, stmcpp::read_write_flag>;
...
// 
using dmar_register = stmcpp::register_wrapper<0x40012c4c, 4, stmcpp::read_write_flag>;
...
// 
using ccr1_register = stmcpp::register_wrapper<0x40012c34, 4, stmcpp::read_write_flag>;
...
// 
using ccr2_register = stmcpp::register_wrapper<0x40012c38, 4, stmcpp::read_write_flag>;
...
// 
using ccr3_register = stmcpp::register_wrapper<0x40012c3c, 4, stmcpp::read_write_flag>;
...
// 
using ccr4_register = stmcpp::register_wrapper<0x40012c40, 4, stmcpp::read_write_flag>;
