...
namespace stmcpp::stm32f051::musart7
{

// 
using cr1_register = stmcpp::register_wrapper<0x40011800, 4, stmcpp::read_write_flag>;
...
// 
using cr2_register = stmcpp::register_wrapper<0x40011804, 4, stmcpp::read_write_flag>;
...
// 
using cr3_register = stmcpp::register_wrapper<0x40011808, 4, stmcpp::read_write_flag>;
...
// 
using brr_register = stmcpp::register_wrapper<0x4001180c, 4, stmcpp::read_write_flag>;
...
// 
using gtpr_register = stmcpp::register_wrapper<0x40011810, 4, stmcpp::read_write_flag>;
...
// 
using rtor_register = stmcpp::register_wrapper<0x40011814, 4, stmcpp::read_write_flag>;
...
// 
using rqr_register = stmcpp::register_wrapper<0x40011818, 4, stmcpp::read_write_flag>;
...
// 
using isr_register = stmcpp::register_wrapper<0x4001181c, 4, stmcpp::read_only_flag>;
...
// 
using icr_register = stmcpp::register_wrapper<0x40011820, 4, stmcpp::read_write_flag>;
...
// 
using rdr_register = stmcpp::register_wrapper<0x40011824, 4, stmcpp::read_only_flag>;
...
// 
using tdr_register = stmcpp::register_wrapper<0x40011828, 4, stmcpp::read_write_flag>;
