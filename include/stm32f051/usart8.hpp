...
namespace stmcpp::stm32f051::musart8
{

// 
using cr1_register = stmcpp::register_wrapper<0x40011c00, 4, stmcpp::read_write_flag>;
...
// 
using cr2_register = stmcpp::register_wrapper<0x40011c04, 4, stmcpp::read_write_flag>;
...
// 
using cr3_register = stmcpp::register_wrapper<0x40011c08, 4, stmcpp::read_write_flag>;
...
// 
using brr_register = stmcpp::register_wrapper<0x40011c0c, 4, stmcpp::read_write_flag>;
...
// 
using gtpr_register = stmcpp::register_wrapper<0x40011c10, 4, stmcpp::read_write_flag>;
...
// 
using rtor_register = stmcpp::register_wrapper<0x40011c14, 4, stmcpp::read_write_flag>;
...
// 
using rqr_register = stmcpp::register_wrapper<0x40011c18, 4, stmcpp::read_write_flag>;
...
// 
using isr_register = stmcpp::register_wrapper<0x40011c1c, 4, stmcpp::read_only_flag>;
...
// 
using icr_register = stmcpp::register_wrapper<0x40011c20, 4, stmcpp::read_write_flag>;
...
// 
using rdr_register = stmcpp::register_wrapper<0x40011c24, 4, stmcpp::read_only_flag>;
...
// 
using tdr_register = stmcpp::register_wrapper<0x40011c28, 4, stmcpp::read_write_flag>;
