...
namespace stmcpp::stm32f051::mi2c2
{

// 
using cr1_register = stmcpp::register_wrapper<0x40005800, 4, readj-write>;
...
// 
using cr2_register = stmcpp::register_wrapper<0x40005804, 4, stmcpp::read_write_flag>;
...
// 
using oar1_register = stmcpp::register_wrapper<0x40005808, 4, stmcpp::read_write_flag>;
...
// 
using oar2_register = stmcpp::register_wrapper<0x4000580c, 4, stmcpp::read_write_flag>;
...
// 
using timingr_register = stmcpp::register_wrapper<0x40005810, 4, stmcpp::read_write_flag>;
...
// 
using timeoutr_register = stmcpp::register_wrapper<0x40005814, 4, stmcpp::read_write_flag>;
...
// 
using isr_register = stmcpp::register_wrapper<0x40005818, 4, readj-write>;
...
// 
using icr_register = stmcpp::register_wrapper<0x4000581c, 4, stmcpp::write_only_flag>;
...
// 
using pecr_register = stmcpp::register_wrapper<0x40005820, 4, stmcpp::read_only_flag>;
...
// 
using rxdr_register = stmcpp::register_wrapper<0x40005824, 4, stmcpp::read_only_flag>;
...
// 
using txdr_register = stmcpp::register_wrapper<0x40005828, 4, stmcpp::read_write_flag>;
