...
namespace stmcpp::stm32f051::mspi2
{

// 
using cr1_register = stmcpp::register_wrapper<0x40003800, 4, stmcpp::read_write_flag>;
...
// 
using cr2_register = stmcpp::register_wrapper<0x40003804, 4, stmcpp::read_write_flag>;
...
// 
using sr_register = stmcpp::register_wrapper<0x40003808, 4, readj-write>;
...
// 
using dr_register = stmcpp::register_wrapper<0x4000380c, 4, stmcpp::read_write_flag>;
...
// 
using crcpr_register = stmcpp::register_wrapper<0x40003810, 4, stmcpp::read_write_flag>;
...
// 
using rxcrcr_register = stmcpp::register_wrapper<0x40003814, 4, stmcpp::read_only_flag>;
...
// 
using txcrcr_register = stmcpp::register_wrapper<0x40003818, 4, stmcpp::read_only_flag>;
...
// 
using i2scfgr_register = stmcpp::register_wrapper<0x4000381c, 4, stmcpp::read_write_flag>;
...
// 
using i2spr_register = stmcpp::register_wrapper<0x40003820, 4, stmcpp::read_write_flag>;
