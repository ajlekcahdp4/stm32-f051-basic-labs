...
namespace stmcpp::stm32f051::mgpioc {

//
using moder_register = stmcpp::register_wrapper<0x48000800, 4, stmcpp::read_write_flag>;
...
//
using otyper_register = stmcpp::register_wrapper<0x48000804, 4, stmcpp::read_write_flag>;
...
//
using ospeedr_register = stmcpp::register_wrapper<0x48000808, 4, stmcpp::read_write_flag>;
...
//
using pupdr_register = stmcpp::register_wrapper<0x4800080c, 4, stmcpp::read_write_flag>;
...
//
using idr_register = stmcpp::register_wrapper<0x48000810, 4, stmcpp::read_only_flag>;
...
//
using odr_register = stmcpp::register_wrapper<0x48000814, 4, stmcpp::read_write_flag>;
...
//
using bsrr_register = stmcpp::register_wrapper<0x48000818, 4, stmcpp::write_only_flag>;
...
//
using lckr_register = stmcpp::register_wrapper<0x4800081c, 4, stmcpp::read_write_flag>;
...
//
using afrl_register = stmcpp::register_wrapper<0x48000820, 4, stmcpp::read_write_flag>;
...
//
using afrh_register = stmcpp::register_wrapper<0x48000824, 4, stmcpp::read_write_flag>;
...
//
using brr_register = stmcpp::register_wrapper<0x48000828, 4, stmcpp::write_only_flag>;
