...
namespace stmcpp::stm32f051::mgpiof
{

// 
using moder_register = stmcpp::register_wrapper<0x48001400, 4, stmcpp::read_write_flag>;
...
// 
using otyper_register = stmcpp::register_wrapper<0x48001404, 4, stmcpp::read_write_flag>;
...
// 
using ospeedr_register = stmcpp::register_wrapper<0x48001408, 4, stmcpp::read_write_flag>;
...
// 
using pupdr_register = stmcpp::register_wrapper<0x4800140c, 4, stmcpp::read_write_flag>;
...
// 
using idr_register = stmcpp::register_wrapper<0x48001410, 4, stmcpp::read_only_flag>;
...
// 
using odr_register = stmcpp::register_wrapper<0x48001414, 4, stmcpp::read_write_flag>;
...
// 
using bsrr_register = stmcpp::register_wrapper<0x48001418, 4, stmcpp::write_only_flag>;
...
// 
using lckr_register = stmcpp::register_wrapper<0x4800141c, 4, stmcpp::read_write_flag>;
...
// 
using afrl_register = stmcpp::register_wrapper<0x48001420, 4, stmcpp::read_write_flag>;
...
// 
using afrh_register = stmcpp::register_wrapper<0x48001424, 4, stmcpp::read_write_flag>;
...
// 
using brr_register = stmcpp::register_wrapper<0x48001428, 4, stmcpp::write_only_flag>;
