...
namespace stmcpp::stm32f051::mtim6
{

// 
using cr1_register = stmcpp::register_wrapper<0x40001000, 4, stmcpp::read_write_flag>;
...
// 
using cr2_register = stmcpp::register_wrapper<0x40001004, 4, stmcpp::read_write_flag>;
...
// 
using dier_register = stmcpp::register_wrapper<0x4000100c, 4, stmcpp::read_write_flag>;
...
// 
using sr_register = stmcpp::register_wrapper<0x40001010, 4, stmcpp::read_write_flag>;
...
// 
using egr_register = stmcpp::register_wrapper<0x40001014, 4, stmcpp::write_only_flag>;
...
// 
using cnt_register = stmcpp::register_wrapper<0x40001024, 4, stmcpp::read_write_flag>;
...
// 
using psc_register = stmcpp::register_wrapper<0x40001028, 4, stmcpp::read_write_flag>;
...
// 
using arr_register = stmcpp::register_wrapper<0x4000102c, 4, stmcpp::read_write_flag>;
