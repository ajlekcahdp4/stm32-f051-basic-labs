...
namespace stmcpp::stm32f051::mgpioe
{

// 
using moder_register = stmcpp::register_wrapper<0x48001000, 4, stmcpp::read_write_flag>;
...
// 
using otyper_register = stmcpp::register_wrapper<0x48001004, 4, stmcpp::read_write_flag>;
...
// 
using ospeedr_register = stmcpp::register_wrapper<0x48001008, 4, stmcpp::read_write_flag>;
...
// 
using pupdr_register = stmcpp::register_wrapper<0x4800100c, 4, stmcpp::read_write_flag>;
...
// 
using idr_register = stmcpp::register_wrapper<0x48001010, 4, stmcpp::read_only_flag>;
...
// 
using odr_register = stmcpp::register_wrapper<0x48001014, 4, stmcpp::read_write_flag>;
...
// 
using bsrr_register = stmcpp::register_wrapper<0x48001018, 4, stmcpp::write_only_flag>;
...
// 
using lckr_register = stmcpp::register_wrapper<0x4800101c, 4, stmcpp::read_write_flag>;
...
// 
using afrl_register = stmcpp::register_wrapper<0x48001020, 4, stmcpp::read_write_flag>;
...
// 
using afrh_register = stmcpp::register_wrapper<0x48001024, 4, stmcpp::read_write_flag>;
...
// 
using brr_register = stmcpp::register_wrapper<0x48001028, 4, stmcpp::write_only_flag>;
