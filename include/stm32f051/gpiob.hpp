...
namespace stmcpp::stm32f051::mgpiob
{

// 
using moder_register = stmcpp::register_wrapper<0x48000400, 4, stmcpp::read_write_flag>;
...
// 
using otyper_register = stmcpp::register_wrapper<0x48000404, 4, stmcpp::read_write_flag>;
...
// 
using ospeedr_register = stmcpp::register_wrapper<0x48000408, 4, stmcpp::read_write_flag>;
...
// 
using pupdr_register = stmcpp::register_wrapper<0x4800040c, 4, stmcpp::read_write_flag>;
...
// 
using idr_register = stmcpp::register_wrapper<0x48000410, 4, stmcpp::read_only_flag>;
...
// 
using bsrr_register = stmcpp::register_wrapper<0x48000418, 4, stmcpp::write_only_flag>;
...
// 
using lckr_register = stmcpp::register_wrapper<0x4800041c, 4, stmcpp::read_write_flag>;
...
// 
using afrl_register = stmcpp::register_wrapper<0x48000420, 4, stmcpp::read_write_flag>;
...
// 
using afrh_register = stmcpp::register_wrapper<0x48000424, 4, stmcpp::read_write_flag>;
...
// 
using brr_register = stmcpp::register_wrapper<0x48000428, 4, stmcpp::write_only_flag>;
