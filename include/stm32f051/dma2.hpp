...
namespace stmcpp::stm32f051::mdma2
{

// 
using isr_register = stmcpp::register_wrapper<0x40020400, 4, stmcpp::read_only_flag>;
...
// 
using ifcr_register = stmcpp::register_wrapper<0x40020404, 4, stmcpp::write_only_flag>;
