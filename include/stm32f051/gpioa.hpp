...
namespace stmcpp::stm32f051::mgpioa
{

// 
using moder_register = stmcpp::register_wrapper<0x48000000, 4, stmcpp::read_write_flag>;
...
// 
using otyper_register = stmcpp::register_wrapper<0x48000004, 4, stmcpp::read_write_flag>;
...
// 
using ospeedr_register = stmcpp::register_wrapper<0x48000008, 4, stmcpp::read_write_flag>;
...
// 
using pupdr_register = stmcpp::register_wrapper<0x4800000c, 4, stmcpp::read_write_flag>;
...
// 
using idr_register = stmcpp::register_wrapper<0x48000010, 4, stmcpp::read_only_flag>;
...
// 
using odr_register = stmcpp::register_wrapper<0x48000014, 4, stmcpp::read_write_flag>;
...
// 
using lckr_register = stmcpp::register_wrapper<0x4800001c, 4, stmcpp::read_write_flag>;
...
// 
using afrl_register = stmcpp::register_wrapper<0x48000020, 4, stmcpp::read_write_flag>;
...
// 
using afrh_register = stmcpp::register_wrapper<0x48000024, 4, stmcpp::read_write_flag>;
...
// 
using brr_register = stmcpp::register_wrapper<0x48000028, 4, stmcpp::write_only_flag>;
